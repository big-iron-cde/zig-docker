...
pub fn build(b: *std.Build) !void {
    ...
    const docker_module = b.addModule("docker", .{ .root_source_file = b.path("src/direct.zig"), .target = target, .optimize = optimize });

    try b.modules.put(b.dupe("docker"), docker_module);
